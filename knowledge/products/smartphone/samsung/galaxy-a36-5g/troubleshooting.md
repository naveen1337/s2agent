...
title: Samsung Galaxy A36 5G — Troubleshooting
description: Model-specific issues and fixes for Samsung Galaxy A36 5G.
tags: [smartphone, samsung, troubleshooting]
status: draft
...
Model-specific issues, error codes, and fixes for `Samsung Galaxy A36 5G`.

## Known Issues

- [ ] Issue: symptoms → checks → fix
